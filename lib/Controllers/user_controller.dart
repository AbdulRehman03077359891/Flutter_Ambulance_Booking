...
class UserController extends GetxController{
  ...
  formRequest(userUid, userName, userEmail, userPic, userContact, userCnic, userAdress, userGender, userBloodType, ambuKey, ambuPic, ambuName, hosName, adminUid) async {
